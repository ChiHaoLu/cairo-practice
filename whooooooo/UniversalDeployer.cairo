...
// $ starknet-compile UniversalDeployer.cairo --output UDC_compiled.json --abi UDC_abi.json
// $ starknet declare --contract UDC_compiled.json
// $ starknet deploy --class_hash 0x6b72dd28172780a252da195c11faeb5fe7536125b2183e1e9ba554243e56e48